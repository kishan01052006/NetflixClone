      ...
      <div className='m-25 '>
        ...
        <div className='flex mt-5'>
            ...
            <div className='flex flex-col ml-7 mt-1'>
                <h2>rahul@gmail.com</h2>
                <div className='mt-3'>
                    <h1 className='font-HK Grotesk font-bold text-[17px] font-700 text-[#CBD5E1]'>Password : **********</h1>
                </div>
            </div>
        </div>
        <hr className='text-[#CBD5E1] mt-5'></hr>
        <div className='flex mt-5'>
            <p className='font-HK Grotesk font-bold text-[19px] font-600 text-[#CBD5E1]'>Plan Details</p>
            <p className='ml-5 mt-1'>Premium ULTRA HD</p>
            </div>
             <hr className='text-[#CBD5E1] mt-5'></hr>
             <div className='flex justify-center mt-15'>
                <button className='bg-[#E50914] h-[40px] w-[70px] text-center rounded-lg cursor-pointer' onClick={handleLogout}>Logout</button>
             </div>
      </div>
